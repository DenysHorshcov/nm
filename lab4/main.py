...
# --------------------------------------------
# 1) Пряма інтерполяція Ньютона
# --------------------------------------------
def direct_interpolation():
    print("\n=== Пряма інтерполяція Ньютона ===\n")
...
# --------------------------------------------
# 2) ОБЕРНЕНА ІНТЕРПОЛЯЦІЯ (твій код — НЕ ЗМІНЕНО!)
# --------------------------------------------
def reverse_interpolation():
    print("\n=== Обернена інтерполяція Ньютона ===\n")
    ...
    print("Результат:", newton_polynomial(x, x_values, div_diff))
...
while True:
    print("\nОберіть метод:")
    print("1 — Пряма інтерполяція Ньютона")
    print("2 — Обернена інтерполяція Ньютона (оригінальний код)")
    print("3 — Вихід")
    ...
    if mode == "1":
        ...
        print("Некоректний вибір, спробуйте ще.")
